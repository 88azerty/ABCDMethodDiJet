...
RunAnalysis: LLGAnalysis.o RunAnalysis.o ObjectID.o cutflowSignalRegion.o cutflowRecoJetEfficiencyAnalysis.o cutflowGenHTAnalysis.o cutflowMETTriggerEfficiencyDetermination.o cutflowTriggerCheck.o cutflowVertexStudy.o cutflowMuonTriggerDetermination.o cutflowZJetsTestRegion.o cutflowWJetsTestRegion.o cutflowSignalRegionTruthAnalysis.o cutflowMakeROOTTrees.o cutflowWJetsCR.o 
	$(CXX) -o RunAnalysis RunAnalysis.o LLGAnalysis.o ObjectID.o cutflowSignalRegion.o cutflowRecoJetEfficiencyAnalysis.o cutflowGenHTAnalysis.o cutflowMETTriggerEfficiencyDetermination.o cutflowTriggerCheck.o cutflowVertexStudy.o cutflowMuonTriggerDetermination.o cutflowZJetsTestRegion.o cutflowWJetsTestRegion.o cutflowSignalRegionTruthAnalysis.o cutflowMakeROOTTrees.o cutflowWJetsCR.o $(LDFLAGS) $(LIBS)
clean:
	rm -f RunAnalysis
	rm -f *.o
	rm -f *~
